...
CACHE = False
cfg = Config(
    experiment_name="sinusoid_dv2_cb",
    ds_type="otf_coco",
    ...
    n_epochs=15,
    batch_size=256,
    channels_to_blank=[47, 89, 113, 359],
    # channels_to_blank=[74, 123, 149, 267],
    ...
    # backbone_checkpoint="models/checkpoints/backbones/dinov3_vits_patch16_plus_reg4.pth",
    lp_interval=0.25,
...
# CACHE = False
# cfg = Config(
#     experiment_name="alibi_dv3_norm_wrap_cb_ms",
#     ds_type="otf_coco",
#     ds_path="../JAFAR/data/COCOStuff/dataset/images",
#     img_l=IMG_L,
...
#     conf_path="models/dinov3",
#     existing_checkpoint="experiments/ablations/20260722_1026_alibi_dv3_norm_wrap_cb/best_model.pth",
#     backbone_checkpoint="models/checkpoints/backbones/dinov3_vits_patch16_plus_reg4.pth",
#     save_per=1,
#     lp_interval=0.05,
#     lp_homog_micros_path="notebooks/paper_figures/data/linear_probe/homog_micros",
